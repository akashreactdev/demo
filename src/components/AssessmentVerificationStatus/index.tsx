...
const AssessmentVerificationStatus: React.FC<VerificationStatusProps> = ({
  status,
  date,
  onClickBtn,
  value,
  ...
  return (
    <CommonCard>
      ...
      <Box mt={4}>
        <ApproveButton title="View Assessment" onClick={onClickBtn} />
      </Box>
      {!status && status !== null && value !== null && value !== "" && (
        <Box mt={4}>
          <Typography variant="h6" fontWeight={500}>
            Assessment feedback
          </Typography>
...
export default AssessmentVerificationStatus;
