...
const Profile = () => {
  ...
  const cardData = [
    {
      ...
      redirectionRoute: `/carers/overview/profile/${params.id}/client-and-job-listings/profile/${params.profile}/care-plan`,
    },
    {
      ...
      redirectionRoute: `/carers/overview/profile/${params.id}/client-and-job-listings/profile/${params.profile}/medical-history`,
    },
    {
      ...
      redirectionRoute: `/carers/overview/profile/${params.id}/client-and-job-listings/profile/${params.profile}/medication-log`,
    },
    {
      title: "Care note",
      description:
      ...
      redirectionRoute: `/carers/overview/profile/${params.id}/client-and-job-listings/profile/${params.profile}/care-notes`,
    },
    {
      title: "Visit log",
      description: "View all the carer entries, timestamps, and key details.",
      buttontext: "View visit logs",
      redirectionRoute: `/carers/overview/profile/${params.id}/client-and-job-listings/profile/${params.profile}/visit-logs`,
    },
    {
      title: "Health log",
      description:
      ...
      redirectionRoute: `/carers/overview/profile/${params.id}/client-and-job-listings/profile/${params.profile}/health-report`,
    },
  ];
  ...
  const handleActionItemClick = (status: string, id: string | number) => {
    navigateWithLoading(
      `/carers/overview/profile/${params.id}/client-and-job-listings/profile/${params.profile}/service-agreement/${id}?status=${status}`
    );
  };
                ...
                userInfo?.completedAgreement?.length > 0 && (
                  <Box mt={4}>
                    <ViewAllButton
                      ...
                      onClick={() =>
                        navigateWithLoading(
                          `/carers/overview/profile/${params.id}/client-and-job-listings/profile/${params.profile}/service-agreement`
                        )
                      }
                    />
                  </Box>
