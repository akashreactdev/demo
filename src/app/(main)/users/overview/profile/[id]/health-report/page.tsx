...
const bloodPressureData: BloodPressureDataPoint[] = [
  { name: "01/01", Systolic: 65, Diastolic: 80 },
  { name: "02/01", Systolic: 70, Diastolic: 85 },
  { name: "03/01", Systolic: 65, Diastolic: 80 },
  { name: "04/01", Systolic: 70, Diastolic: 85 },
  { name: "05/01", Systolic: 65, Diastolic: 80 },
  { name: "06/01", Systolic: 70, Diastolic: 85 },
  { name: "07/01", Systolic: 65, Diastolic: 80 },
  { name: "08/01", Systolic: 70, Diastolic: 85 },
];

const spO2Data: SpO2DataPoint[] = dates.map((date) => ({
  name: date,
  SpO2: 65,
}));

const temperatureData: TemperatureDataPoint[] = dates.map((date) => ({
  name: date,
  Temperature: 60,
}));

const heartRateData: HeartRateDataPoint[] = dates.map((date) => ({
  name: date,
  HeartRate: 60,
}));
