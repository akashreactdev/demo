...
const HealthReportAgreements: React.FC = () => {
  ...
  const handleActionItemClick = (status: string, id: string | number) => {
    navigateWithLoading(
      `/clinical/overview/profile/${params.id}/client-and-job-listings/profile/${params.profile}/health-report/${id}`
    );
  };
...
export default HealthReportAgreements;
