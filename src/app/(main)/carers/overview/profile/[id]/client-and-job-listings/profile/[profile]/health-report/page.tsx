...
const HealthReportAgreementList: React.FC = () => {
  ...
  const handleActionItemClick = (status: string, id: string | number) => {
    navigateWithLoading(
      `/carers/overview/profile/${params.id}/client-and-job-listings/profile/${params.profile}/health-report/${id}`
    );
  };
      ...
      <CommonCard>
        ...
        >
          <Box>
            ...
            >
              You are currently viewing the health report for{" "}
...
export default HealthReportAgreementList;
