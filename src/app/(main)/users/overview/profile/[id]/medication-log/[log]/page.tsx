...
const Profile = () => {
  ...
  const fetchAllLogs = async (
    ...
    userId: string,
    bookingId: string,
    isPrescription: boolean | undefined,
  ...
  const handleActionItemClick = (
    ...
    navigateWithLoading(
      `/users/overview/profile/${params?.id}/medication-log/${agreementid}/medication-log-profile/${id}`
    );
  };
  ...
  const handleActionItemClickForPrescription = (
    ...
    console.log(agreementid, "agreeemntid");
    navigateWithLoading(
      `/users/overview/profile/${params?.id}/medication-log/${agreementid}/prescription/${id}`
    );
  };
